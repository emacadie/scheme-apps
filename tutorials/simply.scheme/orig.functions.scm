;;; The functions program - original

;; first call (load-relative "tutorials/simply.scheme/simply.scm")
;; (load-relative "tutorials/simply.scheme/orig.functions.scm")
;; load after simply.scm
;; found at http://people.eecs.berkeley.edu/~bh/downloads/simply/functions.scm
;; maybe I don't have to re-arrange this?
(define (functions)
  (read-line)
